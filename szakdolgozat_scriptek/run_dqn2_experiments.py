...
def run_experiment(params):
    ...
    if (params['noise_method'] == 'duelingASN') and (params['seed'] == 789):
        return params
...
if __name__ == "__main__":
    ...
    d = {
        'experiment_name': ['dqn_e20'],
        #'env_name': ['Pong'],
        # 'env_name': [ 'Tutankham', 'BeamRider', 'MontezumaRevenge', 'SpaceInvaders', 'Pong'],
         'env_name': [ 'SpaceInvaders-ram', 'Breakout-ram', 'Enduro-ram', 'BeamRider-ram', 'Pong-ram'],
        # 'env_name': [ 'Pendulum-v0', 'MountainCar-v0', 'CartPole-v1', 'Acrobot-v1', 'NChainCustom-v0'],
        # 'env_name': [
